...
public class DetailActivity extends AppCompatActivity {
        ...
        if (Utils.manggiohang.size() > 0){
            ...
            for (int i = 0; i < Utils.manggiohang.size(); i++){
                if (Utils.manggiohang.get(i).getIdsp() == sanPhamMoi.getId()){
                    ...
                    //long gia = Long.parseLong(sanPhamMoi.getGiasp().trim()) * Utils.manggiohang.get(i).getSoluong();
    ...
    private void initData() {
        ...
        giasp.setText("Giá: " + decimalFormat.format(Double.parseDouble(sanPhamMoi.getGiasp())) + "₫");
    ...
    private void initView() {
        ...
        frameLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent giohang = new Intent(getApplicationContext(), ShopActivity.class);
